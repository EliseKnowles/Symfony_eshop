...
class __TwigTemplate_900a8c133bf237a2ba1c84fde9a4d5c2d41efd84c74bd4e96041b386e5d17038 extends Template
{
    ...
    ";
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 9, $this->source); })()), "prenom", [], "any", false, false, false, 9), 'row');
        echo "
        ";
        // line 10
...
{% block title %}{{ 'Compte.newCompte'|trans }}{% endblock %}

{% block body %}
    <h1>{{ 'Compte.newCompte'|trans }}</h1>
